...
OSPiHandle __Dom1SpeedParam __attribute__((aligned(8)));
OSPiHandle __Dom2SpeedParam __attribute__((aligned(8)));
OSPiHandle *__osCurrentHandle[2] __attribute__((aligned(8))) = {&__Dom1SpeedParam, &__Dom2SpeedParam};
